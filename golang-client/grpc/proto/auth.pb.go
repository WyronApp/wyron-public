...
const file_auth_proto_rawDesc = "" +
	...
	"\vCreateAdmin\x12\x18.auth.CreateAdminRequest\x1a\x16.google.protobuf.Empty\x12.\n" +
...
var file_auth_proto_goTypes = []any{
	...
	(*CreateAdminRequest)(nil), // 2: auth.CreateAdminRequest
	(*MeResponse)(nil),         // 3: auth.MeResponse
	(*emptypb.Empty)(nil),      // 4: google.protobuf.Empty
}
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.Login:input_type -> auth.LoginRequest
	2, // 1: auth.AuthService.CreateAdmin:input_type -> auth.CreateAdminRequest
	4, // 2: auth.AuthService.Me:input_type -> google.protobuf.Empty
	1, // 3: auth.AuthService.Login:output_type -> auth.LoginResponse
	4, // 4: auth.AuthService.CreateAdmin:output_type -> google.protobuf.Empty
	3, // 5: auth.AuthService.Me:output_type -> auth.MeResponse
