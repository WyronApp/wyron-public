...
from .wyron_proto import auth_pb2 as auth__pb2
...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateAdmin = channel.unary_unary(
                '/auth.AuthService/CreateAdmin',
                request_serializer=auth__pb2.CreateAdminRequest.SerializeToString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateAdmin': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.CreateAdminRequest.FromString,
...
class AuthService(object):
    ...
    def CreateAdmin(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.AuthService/CreateAdmin',
            auth__pb2.CreateAdminRequest.SerializeToString,
